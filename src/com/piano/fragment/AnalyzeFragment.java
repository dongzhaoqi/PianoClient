...
import com.pianostudy.ui.AnalysysPortraitButtonActivity;

public class AnalyzeFragment extends Fragment implements OnClickListener{
	
	private Button volume_1,volume_2,volume_3,volume_4,volume_5,volume_6,volume_7;
	
	@Override
	public View onCreateView(LayoutInflater inflater,
			 ViewGroup container, Bundle savedInstanceState) {
		
		View v = inflater.inflate(R.layout.frame_analyze, container, false);
	...
	public void onClick(View v) {
		Intent intent = new Intent(getActivity(), AnalysysPortraitButtonActivity.class);
		switch (v.getId()) {
		case R.id.volume_1:
