...
import com.pianostudy.ui.util.PixelUtil;
...
public class HeaderLayout extends LinearLayout {
	...
	public enum HeaderStyle {// 头锟斤拷锟斤拷锟斤拷锟斤拷式
	...
	public void initViews() {
		...
		// findViewByHeaderId(R.id.header_layout_middleview_container);锟叫间部锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟脚ナ憋拷纱锟�		
	...
	public void setTitleAndRightText(CharSequence title, String text,
		...
		mRightImageButton.setBackground(getResources().getDrawable(
				R.drawable.register_btn_selector));
		mRightImageButton.setText(text);
	...
	public void setTitleAndRightOnlyButton(CharSequence title, int backid,
			onRightImageButtonClickListener onRightImageButtonClickListener) {
		setDefaultTitle(title);
		mLayoutRightContainer.setVisibility(View.VISIBLE);
		mRightImageButton.setBackgroundResource(backid);
